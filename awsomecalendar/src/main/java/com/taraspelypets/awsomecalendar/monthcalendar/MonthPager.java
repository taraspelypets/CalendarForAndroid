...
public class MonthPager extends ViewPager implements CalendarPager {
    ...
    /** ATTENTION!
     * Don't use this method to set page. Use @{@link MonthPager#goTo(Calendar)} to set page with given @{@link Calendar} item.
